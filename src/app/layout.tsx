  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `(function(){try{var v=${JSON.stringify(validIds)};var db=${JSON.stringify(dbThemeFamily || null)};var f=localStorage.getItem('devpilot_theme_family')||db||'default';if(v.indexOf(f)<0)f='default';document.documentElement.setAttribute('data-theme-family',f);if(!localStorage.getItem('devpilot_theme_family')&&f!=='default'){localStorage.setItem('devpilot_theme_family',f)}}catch(e){}})();` }} />
