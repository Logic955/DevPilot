...
const zh: Record<TranslationKey, string> = {
  ...
  'settings.saved': '已保存',
  'settings.claudeCliTitle': 'Claude CLI 配置',
  'settings.claudeCliDesc': '为内部版本或非标准 Claude Code 安装自定义路径。',
  'settings.claudeBinaryPath': 'CLI 可执行文件路径',
  'settings.claudeBinaryPathDesc': 'Claude CLI 可执行文件的路径。留空则使用自动检测。',
  'settings.claudeBinaryPathPlaceholder': '例：/usr/local/bin/claude 或 C:\\tools\\claude.exe',
