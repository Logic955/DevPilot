...
const en = {
  ...
  'settings.claudeCliTitle': 'Claude CLI Configuration',
  'settings.claudeCliDesc': 'Customize paths for internal or non-standard Claude Code installations.',
  'settings.claudeBinaryPath': 'CLI Binary Path',
  'settings.claudeBinaryPathDesc': 'Path to the Claude CLI executable. Leave empty to use auto-detection.',
  'settings.claudeBinaryPathPlaceholder': 'e.g. /usr/local/bin/claude or C:\\tools\\claude.exe',
