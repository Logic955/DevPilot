...
export function ProviderDoctorDialog({ open, onOpenChange }: ProviderDoctorDialogProps) {
  ...
  const handleExport = async () => {
    try {
      ...
      a.href = url;
      a.download = `devpilot-doctor-${new Date().toISOString().slice(0, 10)}.json`;
          ...
          <div className="rounded-md border border-border/30 bg-muted/30 px-3 py-2.5 text-xs text-muted-foreground">
            {isZh ? (
              <>
                ...
                请先点击「导出日志」，然后前往{" "}
                <a
                  href="https://github.com/op7418/DevPilot/issues"
                  target="_blank"
                ...
                📖 查看{" "}
                <a
                  href="https://www.devpilot.app/zh/docs/providers"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline text-foreground hover:no-underline"
                >
              ...
              <>
                ...
                📖 See the{" "}
                <a
                  href="https://www.devpilot.app/docs/providers"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="underline text-foreground hover:no-underline"
                >
